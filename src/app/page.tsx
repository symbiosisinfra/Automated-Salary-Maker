      ...
      <main className="container mx-auto p-4">
        ...
        <div className="mb-8 bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4 flex items-center">
            <FileInput className="mr-2 text-blue-600" />
            Import Attendance Data
          </h2>

          <div className="flex items-center flex-wrap gap-4">
            <label className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 cursor-pointer shadow-sm transition-all">
            ...
            {employees.length > 0 && (
              <div className="ml-auto flex flex-wrap gap-2">
                {selectedEmployee && (
                  <>
                    <button
                      ...
                      className="flex items-center px-3 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-gray-400 shadow-sm transition-all"
                    >
                    ...
                    <button
                      onClick={exportToPDF}
                      disabled={exportLoading}
                      className="flex items-center px-3 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:bg-gray-400 shadow-sm transition-all"
                    >
                ...
                <button
                  ...
                  disabled={exportLoading}
                  className="flex items-center px-3 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 disabled:bg-gray-400 shadow-sm transition-all"
                >
                ...
                <button
                  ...
                  disabled={exportLoading}
                  className="flex items-center px-3 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 disabled:bg-gray-400 shadow-sm transition-all"
                >
                ...
                <div
                  ...
                  className={`p-3 mb-2 rounded-md cursor-pointer transition-all ${
                    selectedEmployee?.id === employee.id
                      ? "bg-blue-100 border-l-4 border-blue-500 text-gray-900"
            ...
            <div className="md:w-2/3 lg:w-3/4 bg-white rounded-lg shadow-md p-4">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                >
                  ...
                  {showSettings ? (
                    <ChevronUp className="ml-2 text-gray-600 w-4 h-4" />
                  ) : (
                    <ChevronDown className="ml-2 text-gray-600 w-4 h-4" />
                  )}
                </div>
                ...
                {showSettings && (
                  <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="bg-white border border-gray-200 p-3 rounded-md">
                      <div className="text-sm text-gray-700">Office Hours</div>
                      <div className="font-medium text-gray-900">
                        {OFFICE_START_HOUR}:00 - {OFFICE_END_HOUR}:
                        {OFFICE_END_MINUTE}
                      </div>
                    </div>
                    <div className="bg-white border border-gray-200 p-3 rounded-md">
                      ...
                      <div className="font-medium text-gray-900">
                        {EXPECTED_WORK_MINUTES} mins (
                        {Math.floor(EXPECTED_WORK_MINUTES / 60)} hrs{" "}
                        {EXPECTED_WORK_MINUTES % 60} mins)
                      </div>
                    </div>
                    <div className="bg-white border border-gray-200 p-3 rounded-md">
                      <div className="text-sm text-gray-700">
                        Buffer Minutes Per Day
                      </div>
                      <div className="font-medium text-gray-900">
                    ...
                    <div className="bg-white border border-gray-200 p-3 rounded-md">
                      ...
                      <div className="font-medium text-gray-900">
                        {MAX_BUFFER_DAYS} days per month
                      </div>
                    </div>
                  </div>
                )}
